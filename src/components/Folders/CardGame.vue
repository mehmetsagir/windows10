<template>
  <Layout folderName="CardGame" :overflow="startGame || isGameOver ? false : true">
    <div class="card-container">
    <div class="card" v-for="(image) in imageData" :key="image.id" :class="image.active && 'active'" @click="selectCard(image)">
      <img :src="image.image" alt="Card">
    </div>
    <div class="game-over" v-if="isGameOver">
      <div class="game-over-modal">
        <div class="game-over-modal-header">Game Over</div>
        <div class="game-over-modal-content">Congratulations, you completed the game in {{ gameTime }} seconds!</div>
